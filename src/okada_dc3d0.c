...
/*<        >*/
/* Subroutine */ int dc3d0_(doublereal *alpha, doublereal *x, doublereal *y, doublereal *z__, doublereal *
	depth, doublereal *dip, doublereal *pot1, doublereal *pot2, doublereal *pot3, doublereal *pot4, 
	doublereal *ux, doublereal *uy, doublereal *uz, doublereal *uxx, doublereal *uyx, doublereal *uzx, doublereal *
	uxy, doublereal *uyy, doublereal *uzy, doublereal *uxz, doublereal *uyz, doublereal *uzz, int *
	iret)
{
    /* Initialized data */
    ...
    extern /* Subroutine */ int ua0_(doublereal *, doublereal *, doublereal *,
	     doublereal *, doublereal *, doublereal *, doublereal *, 
	    doublereal *), ub0_(doublereal *, doublereal *, doublereal *, 
	    doublereal *, doublereal *, doublereal *, doublereal *, 
	    doublereal *, doublereal *), uc0_(doublereal *, doublereal *, 
	    doublereal *, doublereal *, doublereal *, doublereal *, 
...
/* Subroutine */ int ua0_(doublereal *x, doublereal *y, doublereal *d__, 
...
/* Subroutine */ int ub0_(doublereal *x, doublereal *y, doublereal *d__, 
	doublereal *z__, doublereal *pot1, doublereal *pot2, doublereal *pot3,
	 doublereal *pot4, doublereal *u)
{
    /* Initialized data */
    ...
    static integer i__;
    static doublereal d12, d32, d33, d53, d54, rd, du[12], fi1, fi2, fi3, fi4,
...
/* Subroutine */ int uc0_(doublereal *x, doublereal *y, doublereal *d__, 
	doublereal *z__, doublereal *pot1, doublereal *pot2, doublereal *pot3,
	 doublereal *pot4, doublereal *u)
{
    /* Initialized data */
