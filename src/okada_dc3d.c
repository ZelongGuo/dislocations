...
/*<        >*/
/* Subroutine */ int dc3d_(doublereal *alpha, doublereal *x, doublereal *y, doublereal *z__, doublereal *
	depth, doublereal *dip, doublereal *al1, doublereal *al2, doublereal *aw1, doublereal *aw2, doublereal *
	disl1, doublereal *disl2, doublereal *disl3, doublereal *ux, doublereal *uy, doublereal *uz, doublereal *
	uxx, doublereal *uyx, doublereal *uzx, doublereal *uxy, doublereal *uyy, doublereal *uzy, doublereal *uxz,
...
/*<         CALL DCCON2(XI(J),ET(K),Q,SD,CD,KXI(K),KET(J)) >*/
	    dccon2_(&xi[j - 1], &et[k - 1], &q, &c0_1.sd, &c0_1.cd, &kxi[k - 
		    1], &ket[j - 1]);
...
/* Subroutine */ int dccon2_(doublereal *xi, doublereal *et, doublereal *q, 
	doublereal *sd, doublereal *cd, integer *kxi, integer *ket)
{
    /* Initialized data */
